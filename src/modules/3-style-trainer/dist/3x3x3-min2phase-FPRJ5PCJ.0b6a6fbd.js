...
})({"1dSr8":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = true;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "575fedc50b6a6fbd";
...
},{}],"97OEN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initialize", ()=>initialize
);
parcelHelpers.export(exports, "solveState", ()=>solveState
);
...
function initDims_0(leafClassLiteral, castableTypeMapExprs, elementTypeIds, leafElementTypeCategory, dimExprs, index_0, count) {
    ...
    if (!isLastDim) {
        ++index_0;
        for(i = 0; i < length_0; ++i)result[i] = initDims_0(leafClassLiteral, castableTypeMapExprs, elementTypeIds, leafElementTypeCategory, dimExprs, index_0, count);
    }
    return result;
}
...
function $clinit_CoordCube() {
    if ($clinit_CoordCube_ran) return;
    $clinit_CoordCube_ran = true;
    UDSliceMove = initDims(C_classLit, [
        $intern_3,
        $intern_26
    ], [
        11,
    ...
    UDSliceConj = initDims(C_classLit, [
        $intern_3,
        $intern_26
    ], [
        11,
    ...
    CCombPConj = initDims(C_classLit, [
        $intern_3,
        $intern_26
    ], [
        11,
...
function initCombPMoveConj() {
    ...
    c = new CubieCube();
    d = new CubieCube();
    CCombPMove = initDims(C_classLit, [
        $intern_3,
        $intern_26
    ], [
        11,
...
function initRawSymPrun(PrunTable, RawMove, RawConj, SymMove, SymState, PrunFlag, fullInit) {
    ...
    if (depth == -1) {
        for(i = 0; i < ~~(N_SIZE / 8) + 1; i++)PrunTable[i] = $intern_29;
        PrunTable[0] ^= 1;
        depth = 0;
    }
...
function $clinit_CubieCube() {
    if ($clinit_CubieCube_ran) return;
    ...
    SymMultInv = initDims(I_classLit, [
        $intern_3,
        $intern_27
    ], [
        17,
...
function $$init(this$static) {
    this$static.ca = initValues(getClassLiteralForArray(B_classLit, 1), $intern_30, 0, 7, [
        0,
        1,
        2,
        3,
    ...
    this$static.ea = initValues(getClassLiteralForArray(B_classLit, 1), $intern_30, 0, 7, [
        0,
        2,
        4,
        6,
    ...
    for(urfInv = 0; urfInv < 6; urfInv++){
        ...
        if (cperm == cpermx) for(i = 0; i < 16; i++){
            ...
            if (equals_7(d.ca, this$static.ca)) {
                ...
                equals_7(d.ea, this$static.ea) && (sym = or(sym, shl({
                    l: 1,
                    m: 0,
                    h: 0
...
function $verify(this$static) {
    ...
    if (sum % 3 != 0) return -5;
    if ((getNParity(getNPerm(this$static.ea, 12, true), 12) ^ getNParity(getNPerm(this$static.ca, 8, false), 8)) != 0) return -6;
    return 0;
}
...
function initSym() {
    ...
    for(i0 = 0; i0 < 8; i0++)lr2.ca[i0] = narrow_byte(lr2.ca[i0] | 24);
    for(i1 = 0; i1 < 16; i1++){
    ...
    for(i2 = 0; i2 < 16; i2++)for(j0 = 0; j0 < 16; j0++){
        ...
        for(k = 0; k < 16; k++)if (equals_7(CubeSym[k].ca, c.ca)) {
            SymMult[i2][j0] = k;
            SymMultInv[k][j0] = i2;
            break;
        }
    ...
    for(j1 = 0; j1 < 18; j1++)for(s = 0; s < 16; s++){
        ...
        for(m = 0; m < 18; m++)if (equals_7(moveCube[m].ca, c.ca)) {
            SymMove_0[s][j1] = m;
...
function $initPhase2(this$static, p2corn, p2csym, p2edge, p2esym, p2mid, edgei, corni) {
    ...
    for(depth2 = this$static.maxDep2; depth2 >= prun; depth2--){
        ...
        for(i0 = 0; i0 < this$static.depth1 + depth2; i0++)$appendSolMove(this$static.solution, this$static.move[i0]);
        for(i = this$static.preMoveLen - 1; i >= 0; i--)$appendSolMove(this$static.solution, this$static.preMoves[i]);
...
function $initPhase2Pre(this$static) {
    ...
    if (gte(this$static.probe, !this$static.solution ? this$static.probeMax : this$static.probeMin)) return 0;
    this$static.probe = add_1(this$static.probe, {
        l: 1,
        m: 0,
        h: 0
    });
...
function $phase1PreMoves(this$static, maxl, lm, cc, ssym) {
    ...
    if (this$static.isRec ? this$static.depth1 == this$static.length1 - this$static.preMoveLen : this$static.preMoveLen == 0 || (225207 >> lm & 1) == 0) {
        ...
        if ($setWithPrun(this$static.nodeUD[this$static.depth1 + 1], cc, this$static.depth1) && $phase1(this$static, this$static.nodeUD[this$static.depth1 + 1], ssym, this$static.depth1, -1) == 0) return 0;
    }
    if (maxl == 0 || this$static.preMoveLen + MIN_P1LENGTH_PRE >= this$static.length1) return 1;
    skipMoves = getSkipMoves(fromInt(ssym));
...
function $search(this$static) {
    for(this$static.length1 = this$static.isRec ? this$static.length1 : 0; this$static.length1 < this$static.solLen; this$static.length1++){
        ...
        for(this$static.urfIdx = this$static.isRec ? this$static.urfIdx : 0; this$static.urfIdx < 6; this$static.urfIdx++){
            ...
            if ($phase1PreMoves(this$static, this$static.maxPreMoves, -30, this$static.urfCubieCube[this$static.urfIdx], toInt(and(this$static.selfSym, {
                l: $intern_20,
                m: 0,
                h: 0
            }))) == 0) return !this$static.solution ? "Error 8" : $toString_2(this$static.solution);
        }
    }
...
function Search() {
    ...
    for(i = 0; i < 20; i++)this.preMoveCubes[i + 1] = new CubieCube();
}
defineClass(72, 1, {
}, Search);
...
function $clinit_Util() {
    ...
    ud2std = initValues(getClassLiteralForArray(I_classLit, 1), $intern_27, 0, 7, [
        0,
        1,
        2,
        4,
    ...
    for(i0 = 0; i0 < 18; i0++)std2ud[ud2std[i0]] = i0;
    for(i1 = 0; i1 < 10; i1++){
        ix = ~~(ud2std[i1] / 3);
        ckmv2bit[i1] = 0;
        for(j = 0; j < 10; j++){
...
function getNPerm(arr, n, isEdge) {
    ...
    for(i = 0; i < n - 1; i++){
        ...
        idx = (n - i) * idx + toInt(and(shr(val, v), {
            l: 15,
            m: 0,
            h: 0
        }));
...
function setComb(arr, idxC, mask, isEdge) {
    ...
    r = 4;
    fill = end;
    for(i = end; i >= 0; i--)if (idxC >= Cnk[i][r]) {
        idxC -= Cnk[i][r--];
...
function setNPerm(arr, idx, n, isEdge) {
    ...
    for(i = 0; i < n - 1; i++){
        ...
        arr[i] = setVal(arr[i], toInt(and(shr(val, v), {
            l: 15,
            m: 0,
            h: 0
        })), isEdge);
    ...
    arr[n - 1] = setVal(arr[n - 1], toInt(and(val, {
        l: 15,
        m: 0,
        h: 0
    })), isEdge);
...
function toCubieCube(f, ccRet) {
    ...
    for(i2 = 0; i2 < 8; i2++){
        for(ori = 0; ori < 3; ori++){
            if (f[cornerFacelet[i2][ori]] == 0 || f[cornerFacelet[i2][ori]] == 3) break;
        }
        col1 = f[cornerFacelet[i2][(ori + 1) % 3]];
        col2 = f[cornerFacelet[i2][(ori + 2) % 3]];
        for(j = 0; j < 8; j++)if (col1 == ~~(cornerFacelet[j][1] / 9) && col2 == ~~(cornerFacelet[j][2] / 9)) {
...
function $toString_2(this$static) {
    ...
    if (urf < 3) for(s = 0; s < this$static.length_0; s++){
        (this$static.verbose & 1) != 0 && s == this$static.depth1 && (sb.string += ".  ");
...
},{"./chunk-WO2AXYFE.js":"dbeiO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1dSr8"], null, "parcelRequire4b33")

//# sourceMappingURL=3x3x3-min2phase-FPRJ5PCJ.0b6a6fbd.js.map
